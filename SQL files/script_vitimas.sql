...
select * from ms where municipio = 'Campo Grande' or municipio = 'Dourados';
select * from ms where vitima > 5;
select * from ms where vitima = 0;
select * from ms where municipio = 'Brasilândia';
select * from ms order by municipio asc;
select * from ms order by municipio desc;
...
#max() e min() trazem o maximo e o minimo de um valor

select * from ms where vitima between 0 and 5;
#between

select * from ms where municipio like 'a%';
select * from ms where municipio like '%a';
#seleciona tudo que começa com 'a', e o segundo tudo que termina com 'a'

select * from ms where municipio like '_r%';
#obrigatoriamente tem de ter 'r' como segunda letra. 
select * from ms where municipio like '%r_';
#funciona do jeito contrario também, estando na penultima. 

select vitima as c from ms;
#seleciona uma tela com um nome diferente

select municipio, vitima from ms where vitima = (select max(vitima) from ms);
select municipio, vitima from ms where vitima = (select min(vitima) from ms);
select count(vitima) from ms;
select avg(vitima) from ms;
select municipio from ms where municipio like 'c%';
select municipio from ms where municipio like 'd%';
select municipio from ms where municipio like 'e%';
